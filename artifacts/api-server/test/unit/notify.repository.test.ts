...
} from "../../src/lib/notion/notify.repository.js";
import {
  makeFakeClient,
  jsonResponse,
  errorResponse,
...
// The restock-alert read side. There is deliberately no marker property here —
// "already alerted" lives in Postgres (`restock_alerts`), so this reads every
// back-in-stock row ever filed and lets the claim decide.
