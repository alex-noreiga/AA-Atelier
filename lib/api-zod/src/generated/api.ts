...
export const GetPortfolioResponse = zod.object({
  ...
  "publishedAt": zod.coerce.date().optional().describe('When the row was created in Notion, used to order the gallery newest-first. Omitted when Notion returned no created time.')
