...
The sections are **Figures / Orders / Requests / Reviews / Bookings / Materials
/ Pay / Settings / Guides**, in that order — what needs doing first. (Orders is
second because advancing a stage is the action taken most often; see "Advancing
an order's stage from the dashboard".) Nothing about a
